...
Pinterest keeps visual discovery at the center and expresses it with red accent, masonry grid, image-first. It works best for image-first platforms, masonry grid layouts, and visual discovery UIs.
...
Pinterest Red for CTAs only — bold and singular
16px radius on buttons/inputs, 20px+ on cards — generous but not pill
Pin Sans is the only font — compact at 12px for UI, 70px for display
Photography carries the design — the UI stays warm and minimal
Plum black (#211922) for text — warmer than pure black
VoltAgent
